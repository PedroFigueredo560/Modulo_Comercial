...
public class Principal_Scren extends javax.swing.JFrame {
    ...
    private void makeLoginEmployee() {
     ...
     private Cliente validarLoginUser() {
        ...
        for (Cliente cli : users) {
            if (cli.getLogin().equals(cli.getLogin()) && cli.getSenha().equals(user.getSenha())) {
                return cli;
            }
        }
    ...
    private void jCheckBoxUserMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckBoxUserMouseClicked
        Register_ScreenUser rgu = new Register_ScreenUser();
        rgu.setVisible(true);
        rgu.pack();
        rgu.setLocationRelativeTo(null);
        rgu.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();                    
